...
Why `cd` is a shell built-in, the shell's cd flow, inode path resolution,
and `cd -L` vs `cd -P`.
================================================================================
...
Key point: Infode is a manifesto file for a directory, and the inode contains the file/directory metadata
